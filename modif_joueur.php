...
<body>
    ...
    <main>
        <div class="list_page">
            ...
            <center>
                <h1>Modification du profil du joueur </h1>
            </center>
                ...
                <div class="profil_joueur">
                    ...
                    <div class="profil_joueur_info">
                        <form action="page_ajt_modif.php" method="POST">
                            ...
                            <p class="information">Poste préféré : </p>
                            <select name="poste_pref" id="poste_pref">
                                <option value="Meneur" <?php if ($poste_pref == "Meneur") echo "selected"; ?>>Poste 1 : Meneur (point guard)</option>
                                <option value="Arrière" <?php if ($poste_pref == "Arrière") echo "selected"; ?>>Poste 2 : Arrière (shooting guard)</option>
                                <option value="Ailier" <?php if ($poste_pref == "Ailier") echo "selected"; ?>> Poste 3 : Ailier (small forward)</option>
                                <option value="Ailier fort" <?php if ($poste_pref == "Ailier fort") echo "selected"; ?>>Poste 4 : Ailier fort (power forward)</option>

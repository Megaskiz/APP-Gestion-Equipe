...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 21 jan. 2023 à 20:32
...
(1, 'LeBron ', 'James', '11111111', '1997-12-17', 2.1, 110.5, 'Ailier', 'projet_photos/63cc3d33b54417.66180220.webp', 'actif', NULL),
...
--
ALTER TABLE `le_match`
  MODIFY `id_le_match` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
